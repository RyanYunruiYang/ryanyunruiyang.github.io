...
<div style="display: flex; align-items: center;">
  <div style="flex: 0 0 auto; margin-right: 20px;">
    <img src="assets/mar26-ghibli.png" alt="Profile Photo" style="max-width: 150px; border-radius: 50%;">
    <p style="text-align: center; font-size: 0.8em; margin-top: 5px;">Generated with Dall-E</p>
  </div>
  <div style="flex: 1;">
    <p>
